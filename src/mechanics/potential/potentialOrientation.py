...
class PotentialOrientation(PotentialShape):
  kind = 'ORIENTATION'
  defaultWeight = GeoGridWeight(active=True, weightLand=.1, weightOceanActive=False, weightOcean=0.1, distanceTransitionStart=100000, distanceTransitionEnd=800000)
